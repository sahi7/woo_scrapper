...
for link in productLinks:
    ...
    product = { "Regular price":regular_price, "SKU":sku, "Name":name, "Description":description, "Short Description":short_description, "Categories":categories, "Images":images }

    productData.append(product)

df = pd.DataFrame(productData)
df.to_csv('spirits.csv', index=False)
